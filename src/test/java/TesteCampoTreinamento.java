...
public class TesteCampoTreinamento {
    ...
    public void testTextFieldDuplo(){
        dsl.escrever("elementosForm:nome", "Isabella");
        Assert.assertEquals("Isabella", dsl.obterValorCampo("elementosForm:nome"));
        dsl.escrever("elementosForm:nome", "Henriques");
        Assert.assertEquals("Henriques", dsl.obterValorCampo("elementosForm:nome"));
    }
